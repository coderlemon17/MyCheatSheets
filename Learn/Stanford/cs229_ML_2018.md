...
- `VC-dimension`:
  ...
  - Note: **shatter** means **any arbitrary labeling**!
    - And consider $h_\theta(x)=I(\theta_0+\theta_1x_1+\theta_2x_2\geq0)$, even if there is some set with size $3$ that $h$ can not shatter: <img src="D:\Learn\MyCheatSheets\Learn\Stanford\pic\image-20200923174122013.png" alt="image-20200923174122013" style="zoom:25%;" />, but as long as there is some set with size $3$ that $h$ can shatter: <img src="D:\Learn\MyCheatSheets\Learn\Stanford\pic\image-20200923174207107.png" alt="image-20200923174207107" style="zoom:25%;" />, then $VC(h)=3$.
- Then we can roughly prove that for $REM$ method, in order to learn "well" using a hypothesis class with $d$ VC-dimension, generally the number of training examples we need is going to be linear in $d$. 
  - <img src="D:\Learn\MyCheatSheets\Learn\Stanford\pic\image-20200923174431144.png" alt="image-20200923174431144" style="zoom:80%;" />
  - ![image-20200923174508268](D:\Learn\MyCheatSheets\Learn\Stanford\pic\image-20200923174508268.png)
...
- <img src="D:/Learn/MyCheatSheets/Learn/Stanford/pic/image-20200730165438776.png" alt="image-20200730165438776" style="zoom:50%;" />
  - How to model an 'L' distribution? --> GMM.

- 1-D example:
  - <img src="D:/Learn/MyCheatSheets/Learn/Stanford/pic/image-20200730165716539.png" alt="image-20200730165716539" style="zoom: 50%;" />
...
- Let $f$ be a convex function ($f''(x) \geq 0$), let $X$ to be a random variable, then $f[E(X)] \leq E[f(x)]$
  - <img src="D:/Learn/MyCheatSheets/Learn/Stanford/pic/image-20200730174717027.png" alt="image-20200730174717027" style="zoom:50%;" />
...
<img src="D:/Learn/MyCheatSheets/Learn/Stanford/pic/image-20200730180343216.png" alt="image-20200730180343216" style="zoom:50%;" />
...
<img src="D:/Learn/MyCheatSheets/Learn/Stanford/pic/image-20200730185849150.png" alt="image-20200730185849150" style="zoom:67%;" />

<img src="D:/Learn/MyCheatSheets/Learn/Stanford/pic/image-20200730185946341.png" alt="image-20200730185946341" style="zoom:67%;" />
