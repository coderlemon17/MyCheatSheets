...
- **The Factor analysis model**: 
  ...
  - Actually $\mu+\Lambda z^i$ is a subspace in $\mathbb{R}^d$, so if target data set is a little noisy around some **subspace** $\in\mathbb{R}^k$, factor analysis model is useful.
