...
<img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\v2-e7e49525a3eeb7a76355f5685f410d22_1440w.jpg" alt="img" style="zoom:50%;" />

<img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\v2-122ce606175d5b35afb9238d96ba0f8d_1440w.jpg" alt="img" style="zoom:50%;" />
...
- Claim: $p_\theta(s_t)$ is close to $p_{\theta'}(s_t)$ when $\pi_\theta$ is close to $\pi_{\theta'}$:
  ...
  - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316171120345.png" alt="image-20210316171120345" style="zoom:40%;" /> 
  ...
  -  General case: proof by [paper](Trust Region Policy Optimization)
    ...
    - ![image-20210316172028830](D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316172028830.png)
      - <font color="grey">$|p_x(x)-p_Y(y)|$ is actually the total *variational divergence* (which can be bounded by the KL divergence).</font>
    - ![image-20210316172521558](D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316172521558.png)

- Applying the deduction back to the original formula:

  - ![image-20210316172722186](D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316172722186.png)
    - <font color="grey">$\frac{1}{1-\gamma}$ is the discount case under infinite horizon case.</font>

- `Summary`:

  - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316173139399.png" alt="image-20210316173139399" style="zoom:50%;" /> 
...
- Implementation:
  - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316174254012.png" alt="image-20210316174254012" style="zoom:50%;" />
...
- Using linear approximation (first order Taylor) of the objective within the trust region:
  - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316184202221.png" alt="image-20210316184202221" style="zoom:50%;" />
    - <font color="grey">And $\nabla_\theta\bar A(\theta)$ is just the normal PG</font>: ![image-20210316184644131](D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316184644131.png)
- Updating $\theta$ directly using PG $\theta\leftarrow\theta+\alpha \nabla_\theta J(\theta)$ will usually **NOT** satisfied the KL-divergence constraints [|=|](because some small change in some parameters will affect the policy dramatically.)
  - Gradient descent/ascent is actually solving: <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316185622869.png" alt="image-20210316185622869" style="zoom:50%;" /> [|=|](Image taking a step to some direction with certain radius constrained by ε.)
    - And the closed form solution for this <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316190541075.png" alt="image-20210316190541075" style="zoom:50%;" />
...
- To impose constraints on the *policy space*:
  - We use a second order Taylor expansion of the KL-divergence:
    - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316191211910.png" alt="image-20210316191211910" style="zoom:50%;" />
...
- `Notes and implement tricks`:
  - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210316192647554.png" alt="image-20210316192647554" style="zoom:67%;" />
...
- How to make better decisions if we've known the transition dynamics (*optimal control/ trajectory optimization/ planning*):
  - Planning: select a *sequence of actions* [|=|](And thus there's no such thing as policy.) to maximize a utility function s.t. future states are determined by the past.
    - E.g. in the deterministic setting: <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210318132201122.png" alt="image-20210318132201122" style="zoom:30%;" />
    - E.g. in the stochastic setting: <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210318132503741.png" alt="image-20210318132503741" style="zoom: 33%;" />
      - `Note`: this *open-loop planning* might not always be the optimal solution.
  - **Loop:**
    - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210318132811352.png" alt="image-20210318132811352" style="zoom:30%;" />

## 10.2. Open-loop Planning and MCTS

- Stochastic optimization (black-box optimization)

	> Abstraction: <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210318133448510.png" alt="image-20210318133448510" style="zoom: 33%;" />
	>
	> Guess && Check: <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210318134357069.png" alt="image-20210318134357069" style="zoom:33%;" />
	...
	- Cross-entropy method (**CEM**): <font color="grey">sample around the potential best.</font>
	  ...
	  - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210318134834376.png" alt="image-20210318134834376" style="zoom:50%;" /> 
	  - `Note`:
...
- Monte Carlo Tree Search:
  ...
  - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210318140201812.png" alt="image-20210318140201812" style="zoom:50%;" /> 
  - <img src="D:\Workspace\MyCheatSheets\Learn\UCB\pic\image-20210318140227660.png" alt="image-20210318140227660" style="zoom:50%;" /> 
  - `Note`:
